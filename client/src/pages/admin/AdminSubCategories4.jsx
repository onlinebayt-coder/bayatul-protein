...
const AdminSubCategories4 = () => {
  ...
  const level4TotalCount = subCategories.length
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Manage your fourth level subcategories
                <span className="ml-2 font-bold text-gray-500">({level4TotalCount})</span>
              </p>
            </div>
            <Link
